          ...
          <div className="p-4">
            ...
            <div className="mb-4">
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-lime-400 focus:border-lime-400 outline-none transition bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                ...
                <table className="min-w-full rounded-xl border border-gray-200 shadow-sm">
                  ...
                  <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                    {sortedItems.map((item, idx) => (
                      ...
                      >
                        {/* Material Name */}
                        <td className="px-3 sm:px-6 py-3 font-medium text-gray-900 dark:text-white whitespace-nowrap">{item.name}</td>
                        {/* Available */}
  ...
  return (
    <div className="p-4">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center gap-3">
        <input
          type="text"
          className="w-full sm:w-96 px-4 py-2 border border-lime-300 dark:border-lime-700 rounded-lg focus:ring-2 focus:ring-lime-400 focus:border-lime-400 outline-none transition bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-300"
      ...
      {deepSearchTerm.trim() && (
        <div className="mb-8 bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 overflow-x-auto animate-fade-in">
          <table className="min-w-full">
            <thead className="bg-lime-100 dark:bg-lime-900/30">
              <tr>
                <th className="px-4 py-2 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Material Name</th>
                <th className="px-4 py-2 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Subgroup</th>
                <th className="px-4 py-2 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Main Group</th>
                <th className="px-4 py-2 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Quantity</th>
                <th className="px-4 py-2 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Unit</th>
                <th className="px-4 py-2 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Cost Per Unit</th>
                <th className="px-4 py-2 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">GST %</th>
                <th className="px-4 py-2 text-left text-xs font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">GST Amount</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {deepSearchResults.length > 0 ? (
                deepSearchResults.map((item, idx) => (
                  <tr key={item.item_id || idx} className={idx % 2 === 0 ? 'bg-gray-50 dark:bg-gray-700/50' : 'bg-white dark:bg-gray-800'}>
                    <td className="px-4 py-2 whitespace-nowrap text-gray-900 dark:text-white">{item.name}</td>
                    <td className="px-4 py-2 whitespace-nowrap text-gray-900 dark:text-white">{item.subgroup}</td>
                    <td className="px-4 py-2 whitespace-nowrap text-gray-900 dark:text-white">{item.mainGroup}</td>
                    <td className="px-4 py-2 whitespace-nowrap text-gray-900 dark:text-white">{item.quantity}</td>
                    <td className="px-4 py-2 whitespace-nowrap text-gray-900 dark:text-white">{item.unit}</td>
                    <td className="px-4 py-2 whitespace-nowrap text-gray-900 dark:text-white">₹{item.cost_per_unit}</td>
                    <td className="px-4 py-2 whitespace-nowrap text-gray-900 dark:text-white">{item.gst || 0}%</td>
                    <td className="px-4 py-2 whitespace-nowrap text-gray-900 dark:text-white">₹{item.gst_amount || 0}</td>
                  </tr>
                ))
              ) : (
                <tr>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            ...
            <div className="flex flex-1 gap-2 items-center justify-end">
              <input
                ...
                className="w-full sm:w-64 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm focus:ring-2 focus:ring-lime-400 focus:border-lime-400 outline-none transition text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-300"
                style={{ maxWidth: 300 }}
              />
              <button
