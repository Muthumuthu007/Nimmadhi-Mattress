...
import { Package2, RefreshCw, Loader2, Search, Trash2, AlertCircle, ArrowUpDown, Settings, Download, ChevronDown, ChevronRight } from 'lucide-react';
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-4">
                        <div className="flex items-start gap-2 sm:gap-3 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-base md:text-lg font-bold text-gray-900 dark:text-white break-words">{product.name}</h3>
                            <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-1">
                              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 break-all">ID: <span className="font-mono font-medium">{product.id}</span></p>
