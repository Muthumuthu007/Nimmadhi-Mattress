...
const DispatchedDailyGrouped = () => {
  ...
  const fetchRecords = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post('/api/reports/dispatch/daily/grouped/', {
        date: selectedDate,
      });
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-violet-600 to-purple-700 rounded-xl shadow-lg p-6">
...
export default DispatchedDailyGrouped;
